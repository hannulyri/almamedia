// Generated on 2015-05-23 using generator-jhipster 2.6.0
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        wiredep: {
            ...
            test: {
                src: 'src/test/javascript/karma/karma.conf.js',
        ...
        karma: {
            unit: {
                configFile: 'src/test/javascript/karma/karma.conf.js',
                singleRun: true
            }
        },
        protractor: {
              ...
              testTargetConfigFile: {
                configFile: "src/test/javascript/protractor/protractor.conf.js",
              },
            },                
        cdnify: {
            dist: {
        ...
        ngconstant: {
            ...
            dev: {
                ...
                constants: {
                    ...
                    APPLICATION_URL: 'http://mepa-store-api.herokuapp.com'
                }
            },
            prod: {
                options: {
